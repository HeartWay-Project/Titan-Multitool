    ...
    def token_check():
        ...
        try:
            try:
                ...
                print(f"{invalid}[{secondary}{current_time_hour()}{invalid}] {GEN_INVALID} Status: {color.WHITE}Invalid{color.RED} | Token: {color.WHITE}{token}{color.RED}")
        except:
            print(f"{invalid}[{secondary}{current_time_hour()}{invalid}] {GEN_INVALID} Status: {color.WHITE}Error{color.RED} | Token: {color.WHITE}{token}{color.RED}")
